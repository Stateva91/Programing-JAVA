...
public class Magazine {
    ...
    public Magazine(String type1, int capacity) {
        this.type1 = type1;
...
public Cloth getSmallestCloth(){
        return data.stream().min(Comparator.comparingInt(Cloth::getSize))
                .orElse(null);
}
...
public String report() {
    ...
    sb.append(String.format("%s magazine contains:%n", type1)).trimToSize();
