...
// Get Latest Car
        ...
        System.out.println(latestCar); // Peugeot 307 (2011) // Get Car Car audiS4 = dealership.getCar("Audi", "S4"); System.out.println(audiS4); // Audi S4 (2005) // Count System.out.println(dealership.getCount()); // 2 // Get Statistics System.out.println(dealership.getStatistics()); // The cars are in a car dealership Autofest: // Peugeot 307 (2011) // Audi S4 (2005)
    }
}
